    ...
    <div class="admin-top-bar">
        <div class="admin-search">
            ...
            <form method="GET" action="<?php echo e(route('quan-ly-nguoi-dung')); ?>">
                ...
                <input type="text" name="keyword" placeholder="Nhập thông tin cần tìm" value="<?php echo e(request('keyword')); ?>">
        ...
        <table id='ListCustomers'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?php echo e(route('xoa-nguoi-dung', ['user_id' => $user->user_id])); ?>" onsubmit="return confirm('Bạn có chắc chắn muốn xóa người dùng này không?')">
                            <?php echo csrf_field(); ?>
