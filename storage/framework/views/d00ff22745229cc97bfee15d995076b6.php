...
<?php $__env->startSection('content'); ?>
    ...
    <div class="admin-top-bar">
        <div class="admin-search">
            ...
            <?php else: ?>
                <a class="update-btn" href="<?php echo e(route('quan-ly-nguoi-dung')); ?>">
        ...
        <table id='ListCustomers'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('quan-ly-nguoi-dung', ['xem' => $user->user_id])); ?>">Chi tiết</a>
                    </td>
                    <td>
                        <form method="POST" action="<?php echo e(route('cap-nhat-vai-tro-nguoi-dung', $user->user_id)); ?>">
                            ...
                            <select name="role">
                                ...
                                <?php if($currentUser->role == 0): ?>
                                    ...
                                    <option value="2" <?php echo e($user->role == 2 ? 'selected' : ''); ?>>Chủ thầu</option>
                                    <option value="3" <?php echo e($user->role == 3 ? 'selected' : ''); ?>>Nhân viên</option>
