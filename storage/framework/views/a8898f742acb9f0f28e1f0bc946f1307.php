...
<?php $__env->startSection('content'); ?> 
                ...
                <?php $__currentLoopData = $groupedDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <?php if($loop->parent->first): ?>
                            ...
                            <td rowspan="<?php echo e($orderRowspan); ?>"><?php echo e($firstDetail->notes ?? 'KhĂ´ng cĂ³ ghi chĂº'); ?></td>
                            <td rowspan="<?php echo e($orderRowspan); ?>">
                                <?php
    ...
    <?php else: ?>
        <h3 style="font-weight: normal; font-size: 17px;">Hiá»‡n táº¡i báº¡n chÆ°a cĂ³ Ä‘Æ¡n Ä‘áº·t sĂ¢n nĂ o.</h3>
    <?php endif; ?>
    <!-- End: Display Orders -->
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.client.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\qldatsan\resources\views/client/account/index.blade.php ENDPATH**/ ?>
