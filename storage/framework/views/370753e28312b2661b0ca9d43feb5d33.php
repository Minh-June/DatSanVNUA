                    ...
                    <?php $__currentLoopData = $yards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="content-item">
                            <div class="content-body">
                                <a href="<?php echo e(route('dat-san', ['yard_id' => $yard->yard_id, 'type_id' => $yard->type_id, 'user_id' => $yard->user_id])); ?>">
                                    <img src="<?php echo e($yardFirstImages[$yard->yard_id] ?? asset('image/football.jpg')); ?>" alt="" class="football-img">
                                </a>
                                <h3 class="content-body-name">
                                    <?php echo e($yard->name); ?>

                                </h3>
                                <a href="<?php echo e(route('dat-san', ['yard_id' => $yard->yard_id, 'type_id' => $yard->type_id, 'user_id' => $yard->user_id])); ?>" class="order-football-btn">
                                    Chọn sân
                                </a>
                            </div>
                        </div>
            ...
            <div class="row contact-content">
                <div class="col col-half contact-infor">
                    ...
                    <p>
                        ...
                        <a href="tel:<?php echo e($admin->phonenb ?? '#'); ?>" class="website-link">
                            <?php echo e($admin->phonenb ?? 'Chưa cập nhật'); ?>
                    ...
                    <p>
                        ...
                        <a href="mailto:<?php echo e($admin->email ?? '#'); ?>" class="website-link">
                            <?php echo e($admin->email ?? 'Chưa cập nhật'); ?>
                    ...
                    <p>
                        ...
                        <a href="<?php echo e($admin->www ?? 'http://gdtc.vnua.edu.vn'); ?>" target="_blank" class="website-link">
                            <?php echo e($admin->www ?? 'Chưa cập nhật'); ?>
