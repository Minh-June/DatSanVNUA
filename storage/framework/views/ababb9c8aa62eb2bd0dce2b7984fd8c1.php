...
<form id="productForm" method="POST" action="<?php echo e(route('luu-san-pham', $store->store_id)); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                ...
                <td>
                    <select name="product_type_id" required>
                        ...
                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->product_type_id); ?>"><?php echo e($type->name); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\laragon\www\qldatsan\resources\views/admin/products/create.blade.php ENDPATH**/ ?>