...
<body>
    ...
    <div id="main">
        ...
        <div id="header">
            <ul id="nav">
                <li>
                    <a class="home-heading <?php echo e(request()->routeIs('trang-chu', 'dat-san', 'getBookedTimes', 'luu-thong-tin-don-dat-san', 'xac-nhan-dat-san', 'xoa-don-tam-thoi', 'thanh-toan', 'pay.upload', 'payment.timeout') ? 'active' : ''); ?>" href="<?php echo e(route('trang-chu')); ?>" target="_top">
                ...
                <li>
                    <a class="home-heading <?php echo e(request()->routeIs('danh-sach-cua-hang') || 
                        ...
                        ? 'active' : ''); ?>" 
                        href="<?php echo e(route('danh-sach-cua-hang')); ?>">
                        <i class="fa-solid fa-cart-shopping"></i> MUA SẮM
                    </a>
                </li>
                <li>
                    <a class="home-heading <?php echo e(request()->routeIs('tin-tuc', 'chi-tiet-tin-tuc') ? 'active' : ''); ?>" href="<?php echo e(route('tin-tuc')); ?>">
            ...
            <div class="header-login">
                ...
                <div class="header__cart"
                    onclick="window.location='<?php echo e(route('gio-hang', ['user_id' => Auth::id()])); ?>'"
                    style="cursor:pointer;">

                    <div class="header__cart-wrap">
                        <i class="header__cart-icon fa-solid fa-cart-shopping"></i>
                        <span class="header__cart-notice"><?php echo e(count(session('buys') ?? [])); ?></span>
                        <?php
                            $groupedBuys = [];
                        ...
                        <?php else: ?>
                            <div class="header__cart-list">
                                ...
                                <ul class="header__cart-list-item">
                                    <?php $__currentLoopData = $groupedBuys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="header__cart-item">
                                            <img src="<?php echo e(asset('storage/' . $item['image']) ?? asset('images/no-image.png')); ?>" 
                                                alt="<?php echo e($item['name']); ?>" class="header__cart-img" />
                                            <div class="header__cart-item-info">
                                                <div class="header__cart-item-name"><?php echo e($item['name']); ?></div>
                                                <div class="header__cart-item-details">
                                                    <span><?php echo e($item['quantity']); ?> x <?php echo e($item['price'] ? number_format($item['price'], 0, ',', '.') . 'đ' : 'Không có giá'); ?></span>
                                                </div>
                                                <?php if(!empty($item['product_size_id'])): ?>
                                                    <div class="header__cart-item-size">
                                                        Size: <?php echo e($sizesMap[$item['product_size_id']] ?? 'Không xác định'); ?>
                                ...
                                <div class="header__cart-total">
                                    <strong>Thành tiền:</strong> <?php echo e(number_format($totalCartPrice, 0, ',', '.')); ?>đ
                                </div>
                                        ...
                                        <li class="header__cal-item">
                                            ...
                                            <div class="header__cal-item-info">
                                                <div class="header__cal-item-head">
                                                    <div class="header__cal-item-name"><?php echo e($order['type_name']); ?></div>
                                                    <div class="header__cal-item-price-wrap">
                                                        <span class="header__cal-item-price"><?php echo e(number_format($order['price'], 0, ',', '.')); ?>đ</span>
                                                        <span class="header__cal-item-multiply">x</span>
                                                        <span class="header__cal-item-qnt"><?php echo e(count($order['times'])); ?></span>
                                                    </div>
                                                </div>
                                                <div class="header__cal-item-body">
                                                    <div class="header__cal-item-body-left">
                                                        <div class="header__cal-item-name"><?php echo e($order['yard_name']); ?></div>
                ...
                <div class="header__bell">
                    <div class="header__bell-wrap">
                        ...
                        <span class="header__bell-notice">
                            <?php echo e(session('notices') ? count(session('notices')) : 0); ?>
                        ...
                        <?php else: ?>
                            <div class="header__cart-list">
                                    ...
                                    <?php $__currentLoopData = $groupedBuys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="header__cart-item">
                                            ...
                                            <div class="header__cart-item-info">
                                                <div class="header__cart-item-name"><?php echo e($item['name']); ?></div>
                                                <div class="header__cart-item-details">
                                                    <span><?php echo e($item['quantity']); ?> x <?php echo e(number_format($item['price'],0,',','.')); ?>đ</span>
                                                </div>
                                                <?php if(!empty($item['size'])): ?>
                                                    <div class="header__cart-item-size">Size: <?php echo e($item['size']); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="header__cart-total">
                                    <p>Thành tiền:</p> <?php echo e(number_format($totalCartPrice,0,',','.')); ?>đ
                                </div>
                                <button class="header__cart-view-cart" onclick="window.location='<?php echo e(route('xac-nhan-dat-san')); ?>'">
                                    Xem giỏ hàng
                                </button>
                            </div>
                        <?php endif; ?>
                ...
                <?php if(Auth::check()): ?>
                    <a href="<?php echo e($user->role != 1 ? route('thong-ke-bao-cao') : route('client.fixed-orders')); ?>" target="_self">
                        <?php if(!empty($user->image)): ?>
                            <img src="<?php echo e(asset('storage/' . $user->image)); ?>" alt="Avatar" class="user-avatar">
                        <?php else: ?>
                            <i class="avatar fa-solid fa-user-tie"></i>
                        <?php endif; ?>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('dang-nhap')); ?>" target="_self">
                        <i class="avatar fa-solid fa-user-tie"></i>
                    </a>
                <?php endif; ?>

                <a class="signup-btn"
                href="<?php echo e(Auth::check() ? ($user->role != 1 ? route('thong-ke-bao-cao') : route('client.fixed-orders')) : route('dang-nhap')); ?>"
                target="_self">
            ...
            <form class="modal-body" method="GET" action="<?php echo e(route('tim-kiem')); ?>">
                ...
                <div class="form-group time-range">
                    ...
                    <input type="time" id="time_from" name="time_from"
                        value="<?php echo e(old('time_from', '06:00')); ?>" required>

                    <label for="time_to">đến</label>
                    <input type="time" id="time_to" name="time_to"
                        value="<?php echo e(old('time_to', '22:00')); ?>" required>
                </div>
