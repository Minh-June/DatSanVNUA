...
<div class="adminedit">
    <form action="<?php echo e(route('luu-thoi-gian-san')); ?>" method="POST">
        ...
        <div class="adminedit-form-group">
            ...
            <input type="time" id="start" name="start" value="<?php echo e(old('start')); ?>" required step="60">
        </div>

        <div class="adminedit-form-group">
            <label for="end">Kết thúc:</label>
            <input type="time" id="end" name="end" value="<?php echo e(old('end')); ?>" required step="60">
        </div>

        <div class="adminedit-form-group">
            <label for="price_weekday">Giá T2-T6 (đ):</label>
            <input type="number" id="price_weekday" name="price_weekday" value="<?php echo e(old('price_weekday')); ?>" step="1000" min="0">
        </div>

        <div class="adminedit-form-group">
            <label for="price_weekend">Giá T7-CN (đ):</label>
            <input type="number" id="price_weekend" name="price_weekend" value="<?php echo e(old('price_weekend')); ?>" step="1000" min="0">
        </div>
