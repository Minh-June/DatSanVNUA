            ...
            <ul id="nav">
                <li>
                    <a class="home-heading" href="<?php echo e(Auth::check() && Auth::user()->role != 1 ? route('admin') : route('trang-chu')); ?>" target="_top">
                        ...
                        <?php endif; ?>
                        <?php echo e(Auth::check() && Auth::user()->role != 1 ? 'TRUNG TÂM QUẢN LÝ' : 'TRANG CHỦ'); ?>
                ...
                <div class="admin">
                    <div class="admin-section-left">
                        ...
                        <div class="admin-manage">
                            <li class="<?php echo e(request()->routeIs('client.fixed-orders') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('client.fixed-orders')); ?>">Đơn thuê cố định</a>
                            </li>
                            ...
                            <li class="<?php echo e(request()->routeIs('lich-su-mua-hang') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('lich-su-mua-hang')); ?>">Lịch sử mua hàng</a>
                            </li> 
