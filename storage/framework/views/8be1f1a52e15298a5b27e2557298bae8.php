...
<?php $__env->startSection('content'); ?>
    ...
    <div class="adminedit">
        ...
        <form method="POST" action="<?php echo e(route('luu-don-dat-san')); ?>">
            ...
            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required pattern="^[\p{L}\s]+$" title="Chỉ nhập chữ cái và khoảng trắng"><br>

            <label>Số điện thoại:</label>
            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" required pattern="^[0-9]+$" title="Chỉ nhập số"><br>
