...
<?php $__env->startSection('content'); ?>
    ...
    <div class="adminedit">
        ...
        <form method="POST" action="<?php echo e(route('luu-don-dat-san')); ?>">
            ...
            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required pattern="^[\p{L}\s]+$" title="Chá»‰ nháº­p chá»¯ cĂ¡i vĂ  khoáº£ng tráº¯ng"><br>

            <label>Sá»‘ Ä‘iá»‡n thoáº¡i:</label>
            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" required pattern="^[0-9]+$" title="Chá»‰ nháº­p sá»‘"><br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\qldatsan\resources\views/admin/orders/create.blade.php ENDPATH**/ ?>
